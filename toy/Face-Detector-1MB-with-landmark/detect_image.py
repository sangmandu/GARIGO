...
known = {"Yoo Jae Seok": ["jaeseok2.jpg", ], "Sang Min": ["sangmin.jpg", ]}
...
if __name__ == '__main__':
    ...
    input_image = "jaeseok.jpg"
    output_image = "output_"+str(args.vis_thres)+"_"+input_image
    ...
    if args.save_image:
        ...
        cv2.imwrite(output_image, img_raw)
